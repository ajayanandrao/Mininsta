...
import brif from "./../Image/brif1.png";
import loc from "./../Image/loc1.png";
                                            ...
                                            <div className='d-flex'>
                                                ...
                                                <div className="weddingList-about-div">
                                                    ...
                                                    <div className="weddingList-about-inner-div">
                                                        ...
                                                        <div className="weddingList-about-inner-item">
                                                            {/* <img src={brif} width={"20px"} style={{marginLeft:"0.2rem" ,marginRight: "0.7rem" }} alt="" /> */}
                                                            <MdWork style={{ fontSize: "24px", color: "#DF7401", marginRight: "0.5rem" }} />
                                                            <span > {item.work} </span>
                                                        </div>
                                                        <div className="weddingList-about-inner-item">
                                                            <img src={loc} width={"26px"} style={{ marginRight: "0.5rem" }} alt="" />
